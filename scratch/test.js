...
function deviceMotionHandler(eventData) {
  ...
  document.getElementById("moFacingUp").innerHTML = facingUp;
  ...
  var translation = "translate(" + acceleration.x + "," + acceleration.y + ")";
  //ctx.translate(acceleration.x,acceleration.y);
  //document.getElementById("imgLogo").style.webkitTransform = translation;
  ball.style.webkitTransform = translation;
}
